...
class Brand(models.Model):
    ...
    api_key = models.CharField(max_length=255, unique=True, help_text="API key for brand authentication")
...
class License(models.Model):
    ...
    status = models.CharField(max_length=20, choices=LicenseStatus.choices, default=LicenseStatus.VALID)
    expiration_date = models.DateTimeField(null=True, blank=True)
    max_seats = models.IntegerField(null=True, blank=True, help_text="Maximum number of activations allowed")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
